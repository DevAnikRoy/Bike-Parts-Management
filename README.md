...
Supabase সেট থাকলে লগইন **ইমেইল OTP** (ফ্রি, SMS নেই)। প্রতিটি ইমেইলের দোকানের ডাটা আলাদা। প্রোডাকশনে env না থাকলে অ্যাপ চালু হবে না (ডেমো ফলব্যাক নেই)। শুধু `npm run dev`-এ localStorage ডেমো চলে।
